...
public class CreateContactEnableNotifyOwner 
{
...
*/
		...
		//implicit wait it is calling it from generic utility
		...
		WebElement actReferance = driver.findElement(By.name("notify_owner"));
		if(actReferance.isEnabled())
		{
			System.out.println("Notify Owner is successfully enabled : pass");
		}
		else
		{
			System.out.println("Notify Owner is not created :FAIL");
		}
